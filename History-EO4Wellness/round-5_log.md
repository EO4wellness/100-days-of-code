...
Under budget - could have done better 
Adequately account for expenses

Budget pre-allocation work to set accurate scope and deliverables 

Tco= total cost of ownership. 

Scope creep

Cash Flow in flow vs out flow

CAPEX AND OPEX
 capital expenses 
operating expenses 
Check with finance dept

Contingency Reserves - risk management 
Buffer 

Management Reserves- usually a percentage  5 to 10 % complexity dictates amount 

PROCUREMENT 
research choices
All materials services and supplies
Vendor management 

Cintractors regional country laws 

Phases of PROCUREMENT process

1. initiating - what help do we need?
2. Selecting
3. Contract writing
4. Control -QA payments 
5. Completing- measures success 
...
SOW after vendor is selected, expectations 
NDA fixed
RFP  fixed, sometimes used as a verb
SMEs subject matter experts 

Disclaimer - such as changes unforeseen etc 
...
## 🌱 R5D26 2026-07-05
    ...
    Project 3: PM - Project Initiation: Starting a Successful Project
```
Gnatt chart-spreadsheet showing our project schedule 

Gnatt Chart should include a list of:
...
** Best Practices ** 
1. Careful review of project deliverables, milestones, and tasks.
2. Give yourself time to plan.
3. Recognize and plan for the inevitable: things will go wrong. 
4. Stay curious. (ask your teammates, the experts in their respective areas, LOTS of questions)
5. Champion your plan. 

In addition, it is also nice to understand the expectation, priorities, risk assessment and communication styles of your stakeholders and vendors. 
```

**RESOURCES**
- [Tables in Google Sheets with Gemini](https://support.google.com/docs/answer/16541386?hl=en&ref_topic=13951627&sjid=34777113035768108-NC) 
- [SmartSheet](https://www.smartsheet.com/) & [Templates](https://www.smartsheet.com/top-excel-project-plan-templates) [TOC](https://www.smartsheet.com/free-google-docs-templates-google-timeline-templates)
- [Asana](https://help.asana.com/s/article/getting-started-video?language=en_US)
- [Get started with Jira](https://www.atlassian.com/software/jira/guides/getting-started/basics#step-1-create-a-project)
...
If you opt to use a software tool rather than a physical board, you have a few options. Asana
 and Trello
 are both great software tools to use if you are looking to introduce Kanban to your project. There are many options, so take the time to evaluate which is best for you and your project.


    Project 4: Python - Loop Control - wrote the loopControlCode.py file 
       Project 8.4 Google Docs 
    Extras: took Udacity quiz for scholarship. 
...
## 🌱 R5D25 2026-07-04
    ...
    Project 3: PM - Project Initiation: Starting a Successful Project
```
applying for more PM roles while studying 
```
    Project 4: Python - Loop Control 
    Project 5: Django for WP Dev
    Project 8.4 Google Docs 
    Extras: HTML/Server maintenance 

## 🌱 R5D24 2026-07-03


    Project 4: Python -  took exam and passed  
    Project 5: Django for WP Dev
    Project 8.3 Google Drive - Templates for Google Drive - completed Google Drive course with certification of completion 
...
2. Milestones. (Important progress monitors. Often this is the completion of a deliverable.)
...
```
    ...
    Project 5: Django for WP Dev
    Project 8.3 Google Drive
    Extras - FreeCodeCamp Spanish; pushed updates to GitHub repo for the WBS examples, template, and thinking guide. 
