## FAQ:
  ...
  **A:** The best way to connect is to use the list of resources available on the official 100DaysOfCode site:
  ...
  Also, here is [an invite link to the 100DaysOfCode Slack channel](https://join.slack.com/t/100xcode/shared_invite/zt-jodfi6gn-QaJ_hk~xrPFK271JwhhXSA).  The Slack space invite link expires every 30 days, or so.  The interaction on the Slack channel (one for every coding language learned) is incredible and highly reocmmended.  If you are here, reading this, and the link doesn't work--reach out for an updated invite link. 
